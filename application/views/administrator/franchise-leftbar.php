...
<!-- Menu aside start -->
            ...
            <ul class="main-navigation">
             <li class="nav-item <?php if(in_array('dashboard',$url)) { echo "has-class";}?>">
                ...
                <li class="nav-item  <?php if(in_array('jobs',$url) || in_array('view-jobs',$url)) { echo "has-class";}?>">
                    <a href="#!">
                        <i class="ti-layout"></i>
                        <span>CSE Requests</span>
                    </a>
                    <ul class="tree-1">
                        <li><a class="<?php if(in_array('view-jobs',$url)) { echo "inner-active";}?>" href="<?php echo base_url(); ?>administrator/cserequest">View CSE Requests</a></li>
                       
                    </ul>
                </li>
                
				<?php /*
				<li class="nav-item <?php if(in_array('pendingsale',$url) || in_array('salereports',$url) || in_array('completedsales',$url) || in_array('orderplaced',$url) ) { echo "has-class";}?>">
                    <a href="#!">
                        <i class="ti-layout"></i>
                        <span>Sales</span>
                    </a>
                 ...
                 <li class="nav-item  <?php if(in_array('resume',$url)) { echo "has-class";}?>">
                    <a href="#!">
                        <i class="ti-layout"></i>
                        <span>Resume</span>
                    </a>
    ...
    <?php endif; ?>
     ...
     <?php if($this->session->flashdata('serviceAccept')): ?>
      <?php echo '<div class="alert alert-success icons-alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <i class="icofont icofont-close-line-circled"></i>
                </button>
                <p><strong>Success! &nbsp;&nbsp;</strong>'.$this->session->flashdata('serviceAccept').'</p></div>'; ?>
    <?php endif; ?>
