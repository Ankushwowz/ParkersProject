...
<!-- Menu aside start -->
            ...
            <ul class="main-navigation">
             <li class="nav-item  <?php if(in_array('dashboard',$url)) { echo "has-class";}?>">
              ...
              <li class="nav-item <?php if(in_array('pendingsale',$url) || in_array('salereports',$url) || in_array('completedsales',$url) || in_array('orderplaced',$url) || in_array('appointment',$url) ) { echo "has-class";}?>">
                ...
                <li class="nav-item <?php if(in_array('cselist',$url)) { echo "has-class";}?>">
                    <a href="#!">
                        <i class="ti-layout"></i>
                        <span>Request for a New Franchise</span>
                    </a>
                    <ul class="tree-1">
                       <li><a class="<?php if(in_array('cselist',$url)) { echo "inner-active";}?>" href="<?php echo base_url(); ?>administrator/cselist">Request for a New Franchise</a></li>
                    </ul>
                </li>

                <!-- <li class="nav-item">
                    <a class="switch-fe1" rel="<?php echo $this->session->userdata('user_id');?>" href="<?php echo base_url(); ?>administrator/requeststatus">
                        <i class="ti-layout"></i>
                        <span>Request for a New Franchise</span>
                    </a>
                </li> -->
    ...
    <div class="main-body">
      ...
      <?php echo '<div class="alert alert-success icons-alert">
                ...
                <p><strong>Success! &nbsp;&nbsp;</strong>'.$this->session->flashdata('payment_success').'</p></div>'; ?>
    <?php endif; ?>
...
<?php if(!empty($_GET['msg']) && $_GET['msg']=='status'){ ?>
			<div class="alert alert-success icons-alert" id="message-alert">
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			<i class="icofont icofont-close-line-circled"></i>
			</button>
			<p> Sale status has been changed successfully</p></div>
			<?php } ?>
