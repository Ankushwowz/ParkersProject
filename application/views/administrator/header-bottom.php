            ...
            <ul class="main-navigation">
             <li class="nav-item has-class">
                ...
                <li class="nav-item">
                    ...
                    <ul class="tree-1">
                        <li><a href="<?php echo base_url(); ?>administrator/jobs/add">Add Job</a></li>
                 ...
                 <li class="nav-item">
                    ...
                    <ul class="tree-1">
                        ...
                        <li><a href="<?php echo base_url(); ?>administrator/dashboard">View Sales</a></li>
                    </ul>
                </li>
                 ...
                 <li class="nav-item">
                    ...
                    <ul class="tree-1">
                        ...
                        <li><a href="<?php echo base_url(); ?>administrator/resume">View Resume</a></li>
                        <!-- <li><a href="<?php echo base_url(); ?>jobs/resumereport">Resume Report</a></li> -->
                        <li><a href="<?php echo base_url(); ?>jobs/assigneresume">Assigned Resume</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="tree-1">
                        <li><a href="<?php echo base_url(); ?>administrator/services/add">Add Services</a></li>
                        <li><a href="<?php echo base_url(); ?>administrator/services/list">List Services</a></li>
                    </ul>
                </li>
