...
<head>
    <title>Administrator - Parker Business Consultancy</title>
	...
	<link href="<?php echo base_url()?>admintemplate/assets/css/loading.css" rel="stylesheet">
	<script src="<?php echo base_url()?>admintemplate/assets/js/loading.js" defer></script>
	<style> .modal {
    z-index: 99999;
}</style>
</head>
