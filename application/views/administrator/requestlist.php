...
<div class="page-header">
								...
								?>
                                 <tr>
										...
										<?php if (in_array($this->session->userdata('role_id'), $role_array)) { ?>
                                              ...
                                              <a  class="label label-inverse-primary change-ferole-cls" rel="<?php echo $post['id']; ?>" rels="<?php echo $post['franchise_id']; ?>" role_id="<?php echo $post['role_id']; ?>"  class="label label-inverse-info" href='#' data-toggle="modal" data-target="#myModalChangerole">Change Role</a>
											  <?php } ?>
    ...
    <div class="modal-body">
        ...
        <input type="hidden" name="frenchid" id="frenchid" >
		</div>
        </div>
