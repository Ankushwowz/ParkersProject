            ...
            <div class="page-body dash">
                <div class="row">
                                    ...
                                    <div class="col-sm-12 card-block-big br">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 text-center">
                                                <h5><?php if(!empty($completed_sales)){ echo count($completed_sales);}else{echo 0;
												} ?></h5>
                   ...
                   <div class="col-md-12 col-xl-4">
                        ...
                        <div class="card table-card">
                            <div class="">
								<a href="<?php echo base_url();?>administrator/pendingsale">
                                <div class="row-table">
                                    <div class="col-sm-12 card-block-big br">
                                        <div class="row">
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-8 text-center">
                                                   <h5><?php if(!empty($pending_sales)){ echo count($pending_sales);}else{ echo 0;} ?></h5>
                    ...
                    <div class="col-md-12 col-xl-4">
                        ...
                        <div class="card table-card">
                            <div class="">
							<a href="<?php echo base_url();?>administrator/teammember">
                                <div class="row-table">
                                    <div class="col-sm-12 card-block-big br">
                                        <div class="row">
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-8 text-center">
                                                <h5><?php if(!empty($team_member)){ echo count($team_member);}else{ echo 0;} ?></h5>
			...
			<div class="row">
				...
				<div class="col-md-3" style="float:left;">
				  ...
				  <?php foreach($users as $usersinfo){?>
				   <option value="<?php echo $usersinfo['id']?>" <?php if(!empty($_POST['user_id']) && $_POST['user_id']==$usersinfo['id']) { echo "selected";}?>><?php echo $usersinfo['username']?></option>
				  <?php } ?>
                           ...
                           <table  class="display table table-bordered table-striped" id="dynamic-table1">
                                ...
                                <tbody>
								  ...
								  $sale_reports_orderid =5000;
								   ...
								   foreach($ordersReportsCse as $post) : 
									$username = json_decode($post['order_data']);
                                 ...
                                 <tr>
									...
									<?php 
									if (in_array($this->session->userdata('role_id'), $array_admin_user)){ ?>
									<td><?php echo $post['franchise_user']; ?><br> <?php if(!empty($post['role_assign_sale_by_user'])){ ?><b class="color-cls" >(<?php echo $post['role_assign_sale_by_user'];?>)</b> <?php } ?></td>
									<?php } ?>
									<?php 
									if (in_array($this->session->userdata('role_id'), $array_admin_user)){ ?>
									<td><?php echo $post['franchise_user']; ?><br><?php if(!empty($post['role_assign_sale_to_user'])) { ?><b class="color-cls">(<?php echo $post['role_assign_sale_to_user'];?>)</b> <?php } ?></td>
										<?php } ?>
									<?php if($this->session->userdata('role_id')==3){?>
									<td><?php echo $post['cse_user_name']; ?></td>
									<?php } ?>
                  ...
                  <div class="col-md-8" style="padding: 0;">
                     <div class="col-md-12">
                        <div class="col-md-8" style="float:left; padding: 0;">
                           <select class="form-control" name="AppointmentHours">
                              <?php for ($x = 1; $x <= 12; $x++) { ?> 
