								...
								?>
                                 <tr>
                                        ...
                                        <td><?php 
                                         ...
                                         <td>
                                            <?php if($post['switch_fe_status'] == '2'){ ?>
                                            <a  rel="<?php echo $post['id']; ?>" rel2="<?php echo $post['franchise_id']; ?>" class="label label-inverse-primary change-roletofe-cls" href="">Request for Franchise</a></td>
                                        <?php } ?>
                                        <!-- <td>
