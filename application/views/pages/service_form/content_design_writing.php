		...
		<section class="service-single">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group"><label class="control-label">Company Website</label><textarea rows="2" name="Company_Website" placeholder="Company Website" class="form-control" required="true"></textarea></div>
					</div>
				</div>
						<div class="row">
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-6">
					<div class="form-group"><label class="control-label">Order Cost</label>
					<div class="input-container">
					<i class="fa fa-gbp icon"></i>
					<input class="input-field form-control digits-cls" type="text" placeholder="Order Cost" name="Service_Amount" required="true">
					</div>
					</div>
					</div>
					<div class="col-md-6">
