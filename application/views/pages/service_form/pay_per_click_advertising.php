...
<!--Page Title-->
		...
		<section class="service-single">
			<div class="container">
				...
				<div class="col-md-6">
				<div class="form-group"><label class="control-label">PPCA cost</label>
				<div class="input-container">
				<i class="fa fa-gbp icon"></i>
				<input class="input-field form-control digits-cls" type="text" placeholder="PPCA cost" name="Service_Amount" required="true">
				</div>
				</div>
				</div>
					<div class="col-md-6">
