			...
			<div class="container">
					...
					<div class="col-md-6">
				     ...
				     <div class="col-md-6">
						<div class="form-group"><label class="control-label">Company Website</label>
							<input type="text"  name="Company_Website" placeholder="Company Website" class="form-control" required="true">
						</div>
						</div> 
				...
				<div class="row">
						...
						<div class="form-group"><label class="control-label">SMO package</label>
							...
							<div class="col-md-6">
						<div class="form-group"><label class="control-label">Set-up Fee</label>
				...
				<div class="row">
				<div class="col-md-6">
							<div class="form-group"><label class="control-label">SMO monthly management Charge</label>
							<div class="input-container">
							<i class="fa fa-gbp icon"></i>
							<input type="text" id="ChargeAmount" name="Service_Amount" placeholder="SMO monthly management Charge" class="form-control digits-cls" value="" required="true"></div>
							</div>
						</div>
					<div class="col-md-6">
