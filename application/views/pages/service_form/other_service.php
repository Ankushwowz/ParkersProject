		...
		<section class="service-single">
			<div class="container">
				...
				<div class="row">
						 ...
						 <div class="col-md-6">
						<div class="form-group"><label class="control-label">Name of the service</label> <input type="text" name="service_Name" placeholder="Name of the service " class="form-control" required="true"></div>
					</div>
							<div class="col-md-6">
						<div class="form-group"><label class="control-label">Cost</label>
						<div class="input-container">
						<i class="fa fa-gbp icon"></i>
							<input type="text" name="Service_Amount" placeholder="Cost" class="form-control digits-cls" required="true"></div>
							</div>
						</div>
				</div>
