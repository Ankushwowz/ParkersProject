...
<!--Page Title-->
		...
		<section class="service-single">
			<div class="container">
			    ...
			    <div class="row">
					<div class="col-md-6">
						<div class="form-group"><label class="control-label">Title</label> <input type="text" name="Title" placeholder="Title" class="form-control" required="true"></div>
					</div>
					<div class="col-md-6">
				...
				<div class="row">
                    ...
                    <div class="col-md-6">
						<div class="form-group"><label class="control-label">Company Website</label> <input type="text" name="Company_Website" placeholder="Company Website" class="form-control" required="true"></div>
					</div>
				</div>
						<div class="row">
					<div class="col-md-6">
				...
				<div class="row">
						...
						<div class="col-md-6">
						<div class="form-group"><label class="control-label">SEO Package</label>
							<select class="form-control" name="Package" required="true" id="packageprice">
				...
				<label class="control-label">SEO Monthly Cost</label>
				<div class="input-container">
				<i class="fa fa-gbp icon"></i>
				<input class="input-field form-control digits-cls" type="text" placeholder="SEO Monthly Cost" name="Service_Amount" required="true" id="ChargeAmount1" value="<?php if(!empty($serviceprice[0]['amount'])) { //echo $serviceprice[0]['amount']; 
				} ?>">
				</div>
				</div>
				</div>
