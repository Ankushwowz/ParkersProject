...
<!--Page Title-->
		...
		<section class="service-single">
			<div class="container">
				...
				<div class="row">
					  <div class="col-md-6">
						<div class="form-group"><label class="control-label">Web Development</label> <input type="text" 
						name="Web_Development" placeholder="Web Development" class="form-control" required="true"></div>
					</div>
					<div class="col-md-6">
						<div class="form-group"><label class="control-label">Web Development cost</label>
                        
						<div class="input-container">
						<i class="fa fa-gbp icon"></i>
						<input class="input-field form-control digits-cls" type="text" placeholder="Web Development cost" name="Service_Amount" required="true">
						</div>
