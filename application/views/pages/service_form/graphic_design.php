...
<!--Page Title-->
		...
		<section class="service-single">
			<div class="container">
				...
				<div class="row">
				<div class="col-md-6">
						<div class="form-group"><label class="control-label">Graphic Design</label>
                        
						
						<input class="input-field form-control" type="text" placeholder="Graphic Design" name="Graphic_Design" required="true">
						...
						<div class="col-md-6">
						<div class="form-group"><label class="control-label">Graphic design cost</label>
                        
						<div class="input-container">
						<i class="fa fa-gbp icon"></i>
						<input class="input-field form-control digits-cls" type="text" placeholder="Graphic design cost" name="Service_Amount" required="true">
						</div>
