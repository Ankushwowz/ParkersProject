			...
			<div class="container">
				...
				<div class="row">
					...
					<?php if($urlid=='2'){?>
						...
						<div class="form-group"><label class="control-label">Website Address</label>
							<textarea  required="true" rows="1" name="Website_Address" placeholder="Website Address" required class="form-control"></textarea>
						</div>
						</div><?php 
					} ?>
					<?php if($urlid=='3'){?>
						...
						<div class="form-group"><label class="control-label">Company Website</label>
							<textarea rows="1" name="Company_Website" placeholder="Website Address" class="form-control" required="true" ></textarea>
						</div>
						</div><?php 
					} ?>
				</div>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<input type="text" name="Setup_Cost" placeholder="Setup Cost" class="form-control digits-cls" required="true"></div>
						</div>
					</div>
					
						<div class="col-md-6">
						<div class="form-group"><label class="control-label">Digital Marketing Charge</label>
						<div class="input-container">
						<i class="fa fa-gbp icon"></i>
							<input type="text" name="Service_Amount" placeholder="Digital Marketing Charge" class="form-control digits-cls" required="true"></div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="input-container">
						<i class="fa fa-gbp icon"></i>
						<input type="text" name="Deposit" placeholder="Deposit" class="form-control digits-cls" required="true"></div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<input type="submit" id="sale_form_submit" class="btn btn-primary submit-btn-primary" name="submit" value="Submit">
					</div>
