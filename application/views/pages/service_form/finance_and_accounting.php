		...
		<section class="service-single">
			<div class="container">
				...
				<div class="row">
					...
					<div class="row">
							<div class="col-md-6">
						<div class="form-group"><label class="control-label">Accountant cost </label>
						<div class="input-container">
						<i class="fa fa-gbp icon"></i>
							<input type="text" name="Service_Amount" placeholder="Accountant cost" class="form-control digits-cls" required="true"></div>
							</div>
						</div>
