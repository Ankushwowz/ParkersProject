...
<!--Page Title-->
		...
		<section class="service-single">
			<div class="container">
				...
				<div class="row">
				  <div class="col-md-6">
					<div class="form-group"><label class="control-label">Brading cost</label>
					<div class="input-container">
					<i class="fa fa-gbp icon"></i>
					<input class="input-field form-control digits-cls" type="text" placeholder="Brading cost" name="Service_Amount" required="true">
					</div></div>
					</div>
					<div class="col-md-6">
